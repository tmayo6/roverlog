...
proc Setup_Options_Table { } {
  ...
  set table(0,0) [ list "arrlsection"  "ARRL-SECTION:" "menu" [ list \
AB \
AK \
AL \
AR \
...
WY \
  ...
  set table(0,3) [ list "category"     "CATEGORY:" "menu" [ list "SINGLE-OP ALL HIGH" "SINGLE-OP ALL LOW" "SINGLE-OP-PORTABLE ALL QRP" "ROVER ALL HIGH" "MULTI-LIMITED LIMITED HIGH" "MULTI-UNLIMITED ALL HIGH" "CHECKLOG ALL HIGH" ] ]
  set table(0,4) [ list "claimedscore" "CLAIMED-SCORE:" "entry" "\"" "\"" ]
  set table(0,5) [ list "operators"    "OPERATORS:" "entry" "\"" "\"" ]
  set table(0,6) [ list "club"         "CLUB:" "entry" "\"" "\"" ]
  set table(0,7) [ list "name"         "NAME:" "entry" "\"" "\"" ]
  set table(0,8) [ list "address1"     "ADDRESS:" "entry" "\"" "\"" ]
  set table(0,9) [ list "address2"     "ADDRESS:" "entry" "\"" "\"" ]
  set table(0,10) [ list "address3"     "ADDRESS:" "entry" "\"" "\"" ]
  set table(0,11) [ list "soapbox1"     "SOAPBOX:" "entry" "\"" "\"" ]
  set table(0,12) [ list "soapbox2"     "SOAPBOX:" "entry" "\"" "\"" ]
  set table(0,13) [ list "soapbox3"     "SOAPBOX:" "entry" "\"" "\"" ]
}
...
# defaults
set ::setting(arrlsection) "WNY"
set ::setting(contest) "ARRL-VHF-JAN"
set ::setting(mycall) "N0NE/R"
set ::setting(category) "ROVER ALL HIGH"
set ::setting(claimedscore) "0"
set ::setting(operators) "N0NE, N0OP"
set ::setting(club) "Virtual Amateur Radio Club"
